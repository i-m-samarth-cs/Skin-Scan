        ...
        with col1:
            if uploaded_file is not None:
                ...
                try:
                    ...
                    st.info("Try uploading a different image format (JPG or PNG recommended)")
                ...
                # Notes input
                st.session_state.notes = st.text_area("Additional Notes", height=100) except Exception as e:
